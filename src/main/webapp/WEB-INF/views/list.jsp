  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light" style="text-align: center;"><a href="index.html">the man of HGU</a></h1>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <img src="<c:url value="/resources/assets/img/profile-img.jpg"/>" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>UI/UX Designer &amp; Web Developer.</h3>
            <p class="font-italic">
              실전프로젝트1을 수강하고 있는 안수현, 이찬효에 의해 오픈소스를 결합하여 만들어졌습니다.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
            ...
            <div class="resume-item pb-0"> <!-- 가로선 데코하는 애 -->
				...
				<c:forEach items="${list}" var="u">
					<tr>
						<td>${u.seq}</td>
						<td>${u.category}</td>
						<td><a href="details/${u.seq}">${u.title}</a></td>
						<td>${u.writer}</td>
						<td>${u.regdate}</td>
              ...
              <%-- <table border="1" align = "center">
                <th style="width: 8.33%" align = "center"><h4>번호</h4></th>
                <th style="width: 100%" align = "center"><h4>제목</h4></th>
                <th align = "center"><h4>작성자</h4></th>
                <th align = "center"><h4>작성일</h4></th>
                <tr><!-- 첫번째 줄 시작 -->
                    <td>첫번째 칸</td>
                    <td>두번째 칸</td>
                </tr><!-- 첫번째 줄 끝 -->
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<c:url value="/resources/assets/img/portfolio/portfolio-1.jpg"/>" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-1.jpg"/>" data-gall="portfolioGallery" class="venobox" title="App 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-2.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-3.jpg"/>" data-gall="portfolioGallery" class="venobox" title="App 2"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-4.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Card 2"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-5.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Web 2"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-6.jpg"/>" data-gall="portfolioGallery" class="venobox" title="App 3"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-7.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Card 1"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-8.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Card 3"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-links">
                <a href="<c:url value="/resources/assets/img/portfolio/portfolio-9.jpg"/>" data-gall="portfolioGallery" class="venobox" title="Web 3"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item" data-aos="fade-up">
            ...
            <img src="<c:url value="/resources/assets/img/testimonials/testimonials-1.jpg"/>" class="testimonial-img" alt="">
            <h3>Saul Goodman</h3>
            <h4>Ceo &amp; Founder</h4>
          </div>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="100">
            ...
            <img src="<c:url value="/resources/assets/img/testimonials/testimonials-2.jpg"/>" class="testimonial-img" alt="">
            <h3>Sara Wilsson</h3>
            <h4>Designer</h4>
          </div>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="400">
            ...
            <img src="<c:url value="/resources/assets/img/testimonials/testimonials-5.jpg"/>" class="testimonial-img" alt="">
            <h3>John Larson</h3>
            <h4>Entrepreneur</h4>
          </div>
