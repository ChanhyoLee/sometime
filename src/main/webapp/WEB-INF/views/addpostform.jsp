  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <form name="" action="addok" method="post" role="form" class="php-email-form">
        <div class="row">
          <div class="col-lg-9 col-md-9 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-heading"></i></div>
            <h3 class="title">제목</h3><input type="text" id="title" style="width:90%; margin-left: 15px;"/>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-9 col-md-9 icon-box" data-aos="fade-up" data-aos-delay="100">
